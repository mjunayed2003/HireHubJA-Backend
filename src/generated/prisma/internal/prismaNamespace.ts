...
export const ApplicationScalarFieldEnum = {
  ...
  refJobName: 'refJobName',
  refJobCompany: 'refJobCompany',
  refJobTitle: 'refJobTitle',
  refJobRelationship: 'refJobRelationship',
  refJobPhone: 'refJobPhone',
  refJobEmail: 'refJobEmail',
  refJpName: 'refJpName',
  refJpContact: 'refJpContact',
  refJpJurisdiction: 'refJpJurisdiction',
  refJpRelationship: 'refJpRelationship',
  refPastorName: 'refPastorName',
  refPastorChurch: 'refPastorChurch',
  refPastorContact: 'refPastorContact',
  refPastorRelationship: 'refPastorRelationship',
  refRelativeName: 'refRelativeName',
  refRelativeContact: 'refRelativeContact',
  refRelativeRelationship: 'refRelativeRelationship',
  createdAt: 'createdAt',
  editedAt: 'editedAt'
} as const
